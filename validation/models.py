...
from mpb_django.enums import ValidationType, validation_types, position_types
...
class TickerValidation(models.Model):
    ...
    validation_type = models.CharField(choices=((x,x) for x in validation_types),null=False, max_length=500)
